...
const INKARA_TOKEN_CONTRACT_ABI = [
  {
    inputs: [],
...
const INKARA_MARKET_CONTRACT_ABI = [
  {
    inputs: [],
    stateMutability: 'nonpayable',
    type: 'constructor'
...
const INKARA_EVENT_CONTRACT_ABI = [
  {
    inputs: [],
    stateMutability: 'nonpayable',
    type: 'constructor'
...
const INKARA_GAME_CONTRACT_ABI = [
  {
    inputs: [],
    stateMutability: 'nonpayable',
    type: 'constructor'
